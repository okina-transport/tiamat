...
```
curl  -XPOST -H"Content-Type: application/xml" -d@tiamat-export-130117-20170109-094137.xml http://localhost:1997/services/stop_places/netex/restoring_import
```
...
kc exec -it $pod bash
cd /tmp
curl -XPOST -H "Content-type: application/xml" -d@import http://localhost:8777/services/stop_places/netex/restoring_import
```
