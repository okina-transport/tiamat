        ...
        netexStopPlaces.forEach(netexStopPlace -> {
            if (netexStopPlace.getQuays() != null && netexStopPlace.getQuays().getQuayRefOrQuay() != null) {
                ...
                quays.getQuayRefOrQuay().forEach(quay -> {
                    ...
                    if (exportGeneratedMissingQuayser || !isAutoGenerated) {
                        netexQuay.getKeyList().getKeyValue().removeIf(
                                keyValue -> "automaticaly-created-missing-quay".equals(keyValue.getKey())
                                        && "false".equals(keyValue.getValue())
                        );
                ...
                if (!quaysReference.getQuayRefOrQuay().isEmpty()) {
                    netexStopPlace.setQuays(quaysReference);
                } else {
                    netexStopPlace.getQuays().getQuayRefOrQuay().clear();
