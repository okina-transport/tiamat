...
public class NearbyStopPlaceFinder {
    ...
    private final boolean noMergeStopPlaces;
    ...
    public NearbyStopPlaceFinder(StopPlaceRepository stopPlaceRepository,
                                 ...
                                 @Value("${idfm.modeMatch.noMergeSeveralProducers}") boolean noMergeStopPlaces, PeriodicCacheLogger periodicCacheLogger, AlternativeStopTypes alternativeStopTypes) {
        ...
        this.nearbyStopCache = CacheBuilder.newBuilder()
                ...
                .recordStats()
                .build();
        this.noMergeStopPlaces = noMergeStopPlaces;

        periodicCacheLogger.scheduleCacheStatsLogging(nearbyStopCache, logger);
    }

    public StopPlace find(StopPlace stopPlace) {
        return find(stopPlace, false, null);
    }

    public StopPlace find(StopPlace stopPlace, boolean allowOther, Provider provider) {

        if(!noMergeStopPlaces){
            provider = null;
        }
