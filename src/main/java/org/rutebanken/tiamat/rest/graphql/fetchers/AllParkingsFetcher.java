...
@Service("allParkingsFetcher")
@Transactional
class AllParkingsFetcher implements DataFetcher {

    private static final Logger logger = LoggerFactory.getLogger(AllParkingsFetcher.class);
    ...
    public Object get(DataFetchingEnvironment environment) {
        ...
        logger.info("Searching for Parkings with arguments {}", environment.getArguments());
        logger.info("User organisations : {}", userOrgs);

        return parkingRepository.findAllParkingsLastVersionAndValid();
    }
}
