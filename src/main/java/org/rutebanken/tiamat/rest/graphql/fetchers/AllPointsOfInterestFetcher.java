...
@Service("allPointsOfInterestFetcher")
@Transactional
class AllPointsOfInterestFetcher implements DataFetcher {

    private static final Logger logger = LoggerFactory.getLogger(AllPointsOfInterestFetcher.class);
    ...
    public Object get(DataFetchingEnvironment environment) {
        ...
        logger.info("Searching for Points Of Interest with arguments {}", environment.getArguments());
        logger.info("User organisations : {}", userOrgs);

        return pointOfInterestRepository.findAllPOILastVersionAndValid();
    }
}
