...
class AllStopPlacesFetcher implements DataFetcher {
    ...
    AllStopPlacesFetcher(StopPlaceRepository stopPlaceRepository, ParentStopPlacesFetcher parentStopPlacesFetcher, RoleAssignmentExtractor roleAssignmentExtractor) {
    ...
    public Object get(DataFetchingEnvironment environment) {
        ...
        List<StopPlace> stopPlaces = stopPlaceRepository.findAllStopplacesLastVersionAndValid();
