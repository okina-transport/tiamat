...
public class StopPlaceMergeJobService {
    ...
    public Job triggerMerge(List<StopPlaceMergeRequestDto> couples, MergeMode mergeMode, String provider) {
    ...
    public Job getRunningMergeJob() {
        return jobRepository.findByTypeAndStatus(JobType.STOP_PLACE_MERGE, JobStatus.PROCESSING)
                .stream()
                .findFirst()
                .orElse(null);
    }
