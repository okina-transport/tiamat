...
//    @Ignore
    @Test
    public void testExportIdfm() throws JAXBException, ParserConfigurationException, IOException, SAXException, TransformerException, XMLStreamException, InterruptedException {

        StopPlace stopPlace = new StopPlace(new EmbeddableMultilingualString("stop place to be exported"));
        Quay quay = new Quay(new EmbeddableMultilingualString("quay to be exported"));
        HashSet<Quay> quays = new HashSet<>();
        quays.add(quay);
