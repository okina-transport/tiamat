...
public class PoiNetexImportTest extends TiamatIntegrationTest {
    ...
    @Test
    public void testPoiNetex() throws IOException, JAXBException, SAXException, TiamatBusinessException, BindException {
        launchImportForFile("poi.xml");
    }

    @Test
    public void testPoiNetexWithoutName() throws IOException, JAXBException, SAXException, TiamatBusinessException, BindException {
