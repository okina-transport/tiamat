...
public class MergingStopPlaceImporterTest extends TiamatIntegrationTest {
    ...
    public void quaysWithSameCoordinatesMustNotBeAddedMultipleTimes() throws ExecutionException, InterruptedException {
        ...
        StopPlace firstImportResult = mergingStopPlaceImporter.importStopPlaceWithoutNetexMapping(firstStopPlace, false);
        ...
        StopPlace importResult = mergingStopPlaceImporter.importStopPlaceWithoutNetexMapping(secondStopPlace, false);
    ...
    public void updateStopPlaceType() throws ExecutionException, InterruptedException {
        ...
        StopPlace importResult = mergingStopPlaceImporter.importStopPlaceWithoutNetexMapping(newStopPlace, false);
