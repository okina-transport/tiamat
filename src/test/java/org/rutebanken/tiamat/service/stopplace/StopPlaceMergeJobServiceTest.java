...
class StopPlaceMergeJobServiceTest {
    ...
    void triggerMergeRejectsEmptyBody() {
        assertThatThrownBy(() -> service.triggerMerge(List.of(), MergeMode.SAME_PROVIDER, null))
    ...
    void triggerMergeRejectsCoupleWithSameTargetAndOrigin() {
        ...
        Throwable thrown = catchThrowable(() -> service.triggerMerge(List.of(couple), MergeMode.SAME_PROVIDER, null));
        assertThat(thrown)
                .isInstanceOf(WebApplicationException.class)
                .satisfies(e -> assertThat(((WebApplicationException) e).getResponse().getStatus()).isEqualTo(400));
    }
    ...
    void triggerMergeCreatesProcessingJobAndRunsToCompletion() {
        ...
        Job createdJob = service.triggerMerge(List.of(couple), MergeMode.SAME_PROVIDER, "prov1");
        ...
        assertThat(createdJob.getMergeMode()).isEqualTo(MergeMode.SAME_PROVIDER);
        assertThat(createdJob.getProvider()).isEqualTo("prov1");
